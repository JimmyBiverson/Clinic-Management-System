...
<div class="appointment-cta-wrap">
    <div class="container">
        <a href="{{ url('/home/appointment') }}" class="btn btn-primary btn-lg">Make An Appointment</a>
    </div>
</div>
@endsection
